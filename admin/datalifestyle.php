...
$profilesPerPage = isset($_GET['per_page']) ? intval($_GET['per_page']) : 2; // Default to 50 profiles per page
...
$sql = "SELECT COUNT(*) AS user_count FROM 2bd_personal_lifestyle";
...
if (mysqli_num_rows($result) > 0) {
    ...
    $pages_to_show = 2; // You can adjust this number as needed
