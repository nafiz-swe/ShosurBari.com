...
<?php
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<tr class='".$class."'><td>".$row['id']."</td><td>".$row['fullname']."</td><td>".$row['username']."</td><td>".$row['gender']."</td><td>".$row['email']."</td><td>".$row['number']."</td><td>".$row['register_date']."</td><td><a href='edit_user.php?id=$id'>Edit</a></td><td><a href='#' onclick='confirmDelete($id)'>Delete</a></td><td>";
