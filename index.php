...
<!-- -- -- -- -- -- -- -- -- -- -- -- -- ---- -- --
  ...
  <div class="grid_1">
    ...
    <div class="sb-featured-profiles">
      ...
      </br><p style="text-align: center;">এখন পর্যন্ত যেই ২০ টি পাত্র-পাত্রীর বায়োডাটা সব থেকে বেশি  দেখা হয়েছে।</p>
      </div>
    ...
    <div class="shosurbari-animation-form">
        <form action="" method="post" name="SbLogForm" onsubmit="return SbLogineForm()">
            <div class="sb-biodata-amount-list">
                ...
                </br> <p> <span style="color:#ff0000; font-weight: 600;">বি: দ্র:</span> যোগাযোগের জন্য পাত্র-পাত্রীর অভিভাবকের মোবাইল নাম্বার এবং পাত্র-পাত্রীর ইমেইল প্রদান করা হবে। পাত্র-পাত্রীর মোবাইল নাম্বার প্রদান করা হয় না।</p>
            </div>
