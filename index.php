...
<body>
  ...
  <div class="shosurbari-user-info">
    <div class="sb-biodata-amount-list">
      ...
      <span style="color:#06b6d4;">  বিস্তারিত জানতে নিচে আমাদের প্রশ্ন ও উত্তর সেকশনের ১০ থেকে ১৪ নাম্বার আর্টিকেল পর্যন্ত পড়ুন।</p>
    </div>
  ...
  <div class="shosurbari-faq">
		<div class="shosurbari-details">
            ...
            কোনো সার্ভিস চার্জ ছাড়াই একাউন্ট খুলে বায়োডাটা পোস্ট করতে পারবেন। পাত্র-পাত্রী নিজেই অথবা অভিভাবক বায়োডাটা পোস্ট করতে পারবে সহজেই।
						একই সাথে পছন্দের পাত্র-পাত্রীর অভিভাবকের সাথে সরাসরি যোগাযোগ করা যায়। সকল পেশা, ধর্ম, বর্ণ, জেলা, দেশি ও প্রবাসী বাংলাদেশী বাঙ্গালী পাত্রপাত্রী খুঁজে পাওয়ার সহজ মাধ্যম।
					</p>
				</div>  
				</div>
				<div class="jb-accordion-wrapper">
          ...
          <p>পাত্র-পাত্রী নিজেই অথবা অভিভাবক বায়োডাটা পোস্ট করতে পারবেন সহজেই। প্রথমে <a href="register.php">Register</a> পেজ থেকে বায়োডাটা পোস্ট কারীর Name, Username, Email, Number, Gender, Password অপশন পূরণ করে নতুন একটি একাউন্ট খুলতে হবে। তারপর পাত্র-পাত্রীর বায়োডাটা পোস্ট করতে পারবেন সহজেই।
						<br><br>একাউন্ট সফল ভাবে রেজিস্ট্রার হবার পর, My Account পেজ থেকে “বায়োডাটা পোস্ট” সেকশনে ক্লিক করে হাতে যথেষ্ট সময় নিয়ে পাত্র-পাত্রীর বায়োডাটা পোস্ট করুন। প্রোফাইলে পাত্র-পাত্রীর ছবি আপলোড করা বাধ্যতা মূলক নয়। তবে পাত্র-পাত্রীর ছবি ছাড়া অন্য যেকোনো কিছুর ছবি আপলোড করলে বিনা নোটিশে সম্পূর্ণ বায়োডাটা ডিলিট করে দেয়া হবে।</p>
					</div>
				</div>
				<div class="jb-accordion-wrapper">
            ...
            <br> TOPAZ প্লান বা ১০টি বায়োডাটার সাথে যোগাযোগ করতে চাওয়া আগ্রহী ইউজারকে পাত্রপাত্রীর মোবাইল নাম্বার, ই-মেইল এবং অভিভাবকের মোবাইল নাম্বার প্রদান করা হবে।
				...
				<div class="jb-accordion-wrapper">
					...
					<div id="accordion7" class="jb-accordion-content collapse">
						<p>না! শ্বশুরবাড়ি ডটকমে একাউন্ট খোলার পর প্রোফাইলে পাত্র-পাত্রীর ছবি আপলোড করা বাধ্যতা মূলক নয়। তবে পাত্র-পাত্রীর ছবি ছাড়া অন্য যেকোনো কিছুর ছবি আপলোড করলে বিনা নোটিশে সম্পূর্ণ বায়োডাটা ডিলিট করে দেয়া হবে। প্রোফাইলে ছবি আপলোড করার পর যেকোনো সময় ছবি ডিলিট করতে পারবেন।</p>
					</div>
				</div>
				<div class="jb-accordion-wrapper">
        ...
        <div class="jb-accordion-wrapper">
              ...
              <br><br>শ্বশুরবাড়ি ডট কমে কোনো একাউন্ট ছাড়াই আপনি একই সাথে একের অধিক বায়োডাটার সাথে যোগাযোগের জন্য পেমেন্ট সম্পন্ন করতে পারবেন না এবং পছন্দের তালিকায় কোনো বায়োডাটার প্রোফাইল যুক্ত করে রাখতে পারবেন না।
              একই সাথে একের অধিক বায়োডাটার সাথে যোগাযোগের জন্য এবং Choice List পেজে পছন্দের বায়োডাটা গুলো যুক্ত করতে অবশ্যয় শ্বশুরবাড়ি ডট কমে আপনার একাউন্ট থাকতে হবে। কোনো সার্ভিস চার্জ ছাড়াই শ্বশুরবাড়ি ডটকমে একাউন্ট খুলে বায়োডাটা পোস্ট করুন। এবং সার্ভিস চার্জ প্রদান করে একই সাথে একের অধিক বায়োডাটার সাথে সরাসরি যোগাযোগ করুন।
            </p>
					</div>
				</div>
				<div class="jb-accordion-wrapper">
              ...
              <br> <br>TOPAZ প্লান বা ১০টি বায়োডাটার সাথে যোগাযোগ করতে চাওয়া আগ্রহী ইউজারকে পাত্রপাত্রীর মোবাইল নাম্বার, ই-মেইল এবং অভিভাবকের মোবাইল নাম্বার প্রদান করা হবে।
				...
				<div class="jb-accordion-wrapper">
					...
					<div id="accordion14" class="jb-accordion-content collapse">
						<p>না! বিয়ের পর কোনো টাকা নেয়া হয় না। আমাদের মাধ্যমে বিবাহ সম্পন্ন হইলে বিয়ের পরবর্তীতে শ্বশুরবাড়ি ডটকম কতৃপক্ষ পাত্র-পাত্রীর কোনো পক্ষ থেকেই কোনো টাকা নেয় না।</p>
					</div>
				</div>
				<div class="jb-accordion-wrapper">
