...
<body>
  ...
  <div class="flex-container-shosurbaribio">
    ...
    <div id="search-bar">
      <!-- Biodata Single Profile Search For Mobile Start -->
      ...
      <!-- For Mobile Multiple Biodata Search Options START-->
      <div id="filters">
    ...
    <div class="sb_biodata_profile">
      ...
      // Define how many pages to show before and after the current page
      const pagesToShowBeforeAndAfter = 1;
      // Loop through all pages and generate page numbers
        ...
        if (i === 1 || i === totalPages || (i >= currentPage - pagesToShowBeforeAndAfter && i <= currentPage + pagesToShowBeforeAndAfter)) {
          ...
          pageNumberElem.addEventListener("click", (event) => {
  ...
  </div> <!--11st Div / Class=flex-container-shosurbaribio-->
  <!-- -- -- -- -- -- -- -- -- -- -- -- -- ---- -- --
  --                 S  T  A  R  T                 --
  ...
  <script>
    ...
    // E   N   D - MULTIPLE SELECT OPTION SHOW & CHECK BOX for Width Screen
    // S  T  A  R  T - MULTIPLE SELECT OPTION SHOW & CHECK BOX for MOBILE
    ...
    // E   N   D - MULTIPLE SELECT OPTION SHOW & CHECK BOX for MOBILE
    // S  T  A  R  T  - WHEN SEARCH BIODATA, IF EMPTY GENDER SHOW ERROR
