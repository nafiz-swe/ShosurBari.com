            ...
            <div class="wrapper">
              ...
              <div class="checkboxes" id="Lorems">
                ...
                <br>
                  ...
                  <!-- Business Sector-->
                  <input type="checkbox" name="occupation_sector[]" value="Business" class="SelectBox val" />
                    <span class="search-options">ব্যবসায়ী</span>
                  <br>


                  <!-- Students Sector-->
                  <input type="checkbox" name="occupation_sector[]" value="Student" class="SelectBox val" />
