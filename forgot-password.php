...
<body>
    ...
    <?php
        ...
        $smtp_port = 587;
        $smtp_username = "nafizulislam.swe@gmail.com"; //Gmail email
        $smtp_password = "dnngvzwetnirboae"; //Gmail password
        ...
        echo '<script>showPopup("<span> দুঃখিত!</span><br><p>ই-মেইলটি দিয়ে শ্বশুরবাড়ি ডট কমে কোনো একাউন্ট খুঁজে পাওয়া যায়নি। অনুগ্রহ করে রেজিস্টারকৃত ই-মেইল দিয়ে আবার চেষ্টা করুন।<p>");</script>';
        }
        }
    ?>
    <!--=======================================
