  ...
  $result = mysqli_query($conn, $sql);
    ...
    echo '<div class="table-wrapper">';
      ...
      if (isset($_POST['search'])) {
        ...
        $sql = "SELECT * FROM 5bd_family_information WHERE user_id = $searchUserId ORDER BY user_id DESC $limit";
        $result = mysqli_query($conn, $sql);
      } else {
        $sql = "SELECT * FROM 5bd_family_information ORDER BY user_id DESC $limit OFFSET $start";
        $result = mysqli_query($conn, $sql);
      }
