				...
				<div class="sb-biodata" id="personalLife">
					...
					<div class="sb-biodata-option">
						...
						<div class="shosurbari-biodata-field">
							...
							<input type="text" id="edit-name" name="groom_bride_family_number" value="<?php echo $groom_bride_family_number;?>" class="form-text" minlength="9" maxlength="15" required>
						</div>
						<div class="shosurbari-biodata-field">
